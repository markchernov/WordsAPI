window.addEventListener("load", function () {
    ...
    countField.addEventListener("keyup", function (evt) {
        ...
        var checkedButton = document.getElementById("checkbox");

        var checked = checkedButton.checked;


        console.log(checked);

        //xhr.setRequestHeader("X-CaseSensitive", checked);      




        var uri = "/wordsapi/v2/count/" + abbrev + "?caseSensitive=" + checked;


         console.log(uri);

        /*if (checked === "true") {
          uri += "?caseSensitive=" + checked;
         }   
           
        else {uri += "?caseSensitive=" + checked;}*/
