...
res.send(data);
 ...
 if(caseSensitive === "true")   {
  ...
  console.log("In caseSensitive count  if statement true");  
...
console.log("In caseSensitive count  if statement false ");  
...
console.log("In caseSensitive search if statement true ");  
...
+" GROUP BY substr(word,1," + alen + "+1)";
    ...
    console.log("In caseSensitive search if statement false ");  
